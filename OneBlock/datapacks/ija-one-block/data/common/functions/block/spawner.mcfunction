...
execute as @s[scores={ija-a004xa=0..252}] at @s align xz positioned ~0.5 ~ ~0.5 run function common:block/phase1
execute as @s[scores={ija-a004xa=254..683}] at @s align xz positioned ~0.5 ~ ~0.5 run function common:block/phase2
execute as @s[scores={ija-a004xa=685..1386}] at @s align xz positioned ~0.5 ~ ~0.5 run function common:block/phase3
execute as @s[scores={ija-a004xa=1388..2152}] at @s align xz positioned ~0.5 ~ ~0.5 run function common:block/phase4
execute as @s[scores={ija-a004xa=2154..2910}] at @s align xz positioned ~0.5 ~ ~0.5 run function common:block/phase5
execute as @s[scores={ija-a004xa=2912..3709}] at @s align xz positioned ~0.5 ~ ~0.5 run function common:block/phase6
execute as @s[scores={ija-a004xa=3711..4491}] at @s align xz positioned ~0.5 ~ ~0.5 run function common:block/phase7
