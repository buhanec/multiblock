...
execute as @s[scores={ija-a004xa=7035..,ija-a004xc=5}] at @s positioned ~ ~ ~ unless block ~2 ~-2 ~ minecraft:end_portal_frame run function common:fns/spawnendportal

# make it possible for players to respawn end portal by breaking the corner obsidian blocks
execute as @s[scores={ija-a004xa=7035..}] at @s positioned ~ ~ ~ unless block ~2 ~-2 ~2 minecraft:obsidian run function common:fns/respawnendportal
execute as @s[scores={ija-a004xa=7035..}] at @s positioned ~ ~ ~ unless block ~2 ~-2 ~-2 minecraft:obsidian run function common:fns/respawnendportal
execute as @s[scores={ija-a004xa=7035..}] at @s positioned ~ ~ ~ unless block ~-2 ~-2 ~2 minecraft:obsidian run function common:fns/respawnendportal
execute as @s[scores={ija-a004xa=7035..}] at @s positioned ~ ~ ~ unless block ~-2 ~-2 ~-2 minecraft:obsidian run function common:fns/respawnendportal
